...
(function() {
  var Debug, EventEmitter, Now, __debug, default_host, dev_logger, events, logger, os, process_logger, ref, util, w,
    slice = [].slice;
  ...
  module.exports = logger = function(default_name, suffix) {
    ...
    make_debug = (function(_this) {
      return function(e) {
        ...
        return function() {
          var arg, args, data, error, extra, host, message, now, ref1, ref2, session_logger, text;
