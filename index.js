...
(function() {
  var Debug, IO, Now, __debug, cuddly_io, cuddly_url, default_host, dev_logger, events, fs, gelf_config, init, k, logger, map, n, non_call_logger, os, ref, request, uuidV4,
    slice = [].slice,
  ...
  module.exports.init = init = function(cfg) {
