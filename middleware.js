...
(function() {
  var Now, call_logger, init, logger, non_call_logger, uuidV4;
  ...
  non_call_logger = function(suffix) {
    ...
    return this.debug = logger(name, null);
  };

  call_logger = function(session) {
    return this.debug = logger(null, session);
  };
  ...
  this.include = function() {
    ...
    this.session._id = id;
    return call_logger.call(this, this.session);
  };
